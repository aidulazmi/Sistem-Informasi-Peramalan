                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     <a class="btn btn-info btn-sm" href="<?php echo site_url('C_admin/edit_inventory/'.$u->id_inventory);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                      </a>
                      <a class="btn btn-danger btn-sm" href="<?php echo site_url('C_admin/hapus_inventory/'.$u->id_inventory);?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
    ...
    <!-- Tambah Barang-->
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <form action="<?php echo site_url('C_admin/simpan_inventory')?>" method="POST">
                <div class="card-body">
